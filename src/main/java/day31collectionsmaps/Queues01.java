...
public class Queues01 {
    public static void main(String[] args) {
        ...
        System.out.println(wareHouse.element());//[Meat, Bread, Egg, Cheese]
        ...
        System.out.println(wareHouse.remove());//Exception NoSuchElementException Eleman yok olduğu için hata verdi
