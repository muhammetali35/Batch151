...
public class IfStatement01 {
    public static void main(String[] args) {
        //Example 1: Type code to check if a given character is upper
        // case or lower case or others
        char ch= 'S';
        ...
        //Example 2: If a number less than 300 or greater than 3000
        ...
        //Example 3: Type code check if a number is "Even" or "Odd"
        int n=8;
