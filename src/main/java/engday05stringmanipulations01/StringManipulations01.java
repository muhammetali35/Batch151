...
public class StringManipulations01 {
    public static void main(String[] args) {
       ...
       boolean result1= s.charAt(6)=='a';//There are 2 tasks for Java
        ...
        //2.Way:
        boolean result2= s.startsWith("a",6);//There are 2 tasks for Java
        ...
        //Note: When you use replace() method create a container to store updated data in it.

        String newT= t.replace("money","dollar");
        System.out.println(newT);// Learn Java earn dollar

        String newT2= t.replace("Learn","Teaching");//kendim yazdım
        System.out.println(newT2);//Teaching Java earn money
