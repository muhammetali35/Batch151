...
/*
     ...
     */
        ...
        for (int i = 0; i < arr1.length; i++) {//dıştaki arraların kısa olanının sayısınca donguye alıcam
            ...
            for (int j = 0; j < sinir; j++) {
                ...
                System.out.println(i+" , "+j+" indexindeki elemaların toplamı "+toplam);
            }
        }
