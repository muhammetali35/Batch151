...
public class ArrayList02tekrar {
    public static void main(String[] args) {
        ...
        System.out.println(cities);//[Giresun, Yozgat, Miami, Giresun, Yozgat, Giresun]
        ...
        int indexK=initials.indexOf('k');
        System.out.println(indexK);//1

        //lastIndexOf('k') yazarsanız 'k' nın son görünümünün index'ini verir.
        int lastIndexK=initials.lastIndexOf('k');
        System.out.println(lastIndexK);//4
