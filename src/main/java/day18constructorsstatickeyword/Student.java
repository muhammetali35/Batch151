...
public class Student {
   ...
   5)"static" (class member) ları çağırmak için object oluşturmak gerekmez ve tavsiye edilmez.
      "non-static" (class member) ları çağırmak için object oluşturmak şarttır.
     */
