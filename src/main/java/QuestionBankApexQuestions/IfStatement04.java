...
public class IfStatement04 {
    public static void main(String[] args) {
      ...
      // Example; For 1 output is "January", for 2 output is "February" etc.
        ...
        //soru is sorusu ancak 3 den fazla seçenek varsa switch kullanılır.

        Scanner input= new Scanner(System.in);

        System.out.println("Enter the number of the month, please ");
        ...
        switch (numberOfMonth){
            ...
            default: System.out.println("İnvalid  month number ");
