...
public class C01_Array {
    public static void main(String[] args) {
         /*
        Bir Array içerisindeki 'minimum', 'maksimum'  ve 'ikinci maksimum'
         elemanları bulan bir kod yazınız.
       ...
       */
        ...
        System.out.println("Min: "+ arr[0]);//-90
        System.out.println("Max: "+ arr[arr.length-1]);//10001
        System.out.println("2. Max: "+ arr[arr.length-2]);//8787
